...
use Auth;
use JWTAuth;
use Bishopm\Bookclub\Models\Action;
use Bishopm\Bookclub\Repositories\ActionsRepository;
use Bishopm\Bookclub\Repositories\IndividualsRepository;
use Bishopm\Bookclub\Repositories\ProjectsRepository;
use Bishopm\Bookclub\Repositories\FoldersRepository;
use Bishopm\Bookclub\Http\Requests\CreateActionRequest;
use Bishopm\Bookclub\Http\Requests\UpdateActionRequest;
...
class ActionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bookclub::actions.index', $data);
    }
    ...
    public function create($id)
    {
        ...
        return view('bookclub::actions.create', compact('folders', 'tags', 'project'));
    }
    ...
    public function generalcreate()
    {
        ...
        $folders=$this->folders->dropdown();
        $tags=Action::allTags()->get();
        return view('bookclub::actions.gencreate', compact('folders', 'tags', 'projects','individuals'));
    }
    ...
    public function edit(Action $action)
    {
        ...
        return view('bookclub::actions.edit', compact('action', 'project', 'folders', 'tags', 'atags'));
    }
